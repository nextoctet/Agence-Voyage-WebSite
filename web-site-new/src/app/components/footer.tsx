  ...
  return (
    <footer className="bg-[#C07652] text-white pt-24 pb-12 px-8 font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* THE FULLY TRANSLATED NEWSLETTER  */}
    <div className="border-y border-white/20 py-20 mb-24 relative">
      {!subscribed ? (
        <form onSubmit={handleSubscribe} className="flex flex-col lg:flex-row items-center justify-between gap-12 text-center lg:text-left">
          <div className="flex-1">
            <h3 className="text-5xl md:text-6xl font-serif italic tracking-tighter mb-4">
              {t("Postcards from Morocco.")}
            </h3>
            <p className="text-[10px] md:text-xs uppercase tracking-[0.4em] font-bold opacity-70">
              {t("Be the first to discover our hidden gems and local secrets.")}
            </p>
          </div>
          ...
          <div className="w-full lg:w-1/3 relative group">
            <input 
              ...
              className="w-full bg-transparent border-b border-white/40 py-4 text-xs font-bold tracking-[0.2em] focus:outline-none focus:border-white transition-all placeholder:text-white/30"
              required 
            />
            <button 
              type="submit"
              className="absolute right-0 bottom-4 text-[11px] font-black uppercase tracking-[0.2em] hover:text-[#F9F7F2] transition-colors"
            >
              {t("Discover")} ↗
            </button>
          </div>
          ...
          <div className="flex flex-col gap-12">
            <div>
              ...
              <div className="flex gap-5">
                ...
                {/* WhatsApp */}
                <a href={`https://wa.me/${phoneNumber}`} target="_blank" className="hover:scale-125 transition-transform">
