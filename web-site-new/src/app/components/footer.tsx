  ...
  return (
    <footer className="bg-[#C07652] text-white pt-24 pb-12 px-8 font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* SECTION NAVIGATION */}
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-16 mb-20 border-t border-white/20 pt-20 text-left">
          ...
          <div className="flex flex-col gap-6 lg:col-span-1">
            ...
            <div className="flex flex-col gap-2 border-l-2 border-white/30 pl-4">
              <p className="text-[9px] uppercase font-bold tracking-[0.3em] opacity-70">Contact</p>
              <a href={`mailto:${email}`} className="flex items-center gap-2 text-[11px] hover:underline opacity-90">
          ...
          {/* 4. Légal */}
          <div>
            <h3 className="text-[10px] font-bold uppercase tracking-[0.3em] mb-8 opacity-80">{t("Légal")}</h3>
            <ul className="flex flex-col gap-4 text-xs font-medium italic">
              <li className="hover:translate-x-2 transition-all cursor-pointer opacity-90">{t("Conditions de Vente")}</li>
              <li className="hover:translate-x-2 transition-all cursor-pointer opacity-90">{t("Confidentialité")}</li>
              <li className="hover:translate-x-2 transition-all cursor-pointer opacity-90">{t("Gestion des Cookies")}</li>
            </ul>
          </div>

          {/* 5. Suivez-nous */}
          <div>
            <h3 className="text-[10px] font-bold uppercase tracking-[0.3em] mb-8 opacity-80">{t("Suivez-nous")}</h3>
            <div className="flex gap-5">
              {/* Instagram */}
              <a href="https://instagram.com" target="_blank" className="hover:opacity-70 transition-opacity">
              ...
              {/* Facebook */}
              <a href="https://facebook.com" target="_blank" className="hover:opacity-70 transition-opacity">
              ...
              {/* WhatsApp */}
              <a href={`https://wa.me/${phoneNumber}`} target="_blank" className="hover:opacity-70 transition-opacity">
        ...
        <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 text-[9px] font-bold uppercase tracking-[0.5em]">
          <p className="opacity-80">Marrakech, Maroc</p>
