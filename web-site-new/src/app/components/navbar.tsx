  ...
  return (
    <>
      <nav 
        ...
        <Link href="/" className="transition transform hover:scale-105 active:scale-95 flex items-center h-14 md:h-20">
          <Image 
        ...
        <div className="flex items-center gap-6">
          {/* Hna fin dert l-touch l-wa3ra l-selector */}
      ...
      {isDrawerOpen && (
        <div className={`fixed inset-0 z-[100] flex ${montserrat.className}`}>
          ...
          <aside className="relative ml-auto w-64 max-w-[85%] bg-[#F9F7F2] shadow-2xl p-8 flex flex-col h-full overflow-y-auto">
            <button className="absolute top-6 right-6 p-2 text-[#C07652]" onClick={() => setIsDrawerOpen(false)}>
