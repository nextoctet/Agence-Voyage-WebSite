...
export default function AboutPage() {
  ...
  const destinationsData = [
    { nameKey: t("Marrakech"), img: "/pictures/marr.png", descKey: t("Our home city. We know it street by street — the good souks, the restaurants where locals actually eat, and when to go to avoid the crowds.") },
    { nameKey: t("Fez"), img: "/pictures/fezz.png", descKey: t("The most complex medina in the world. Our guides grew up there and know every shortcut, hidden courtyard, and family workshop closed to ordinary tourists.") },
    ...
    { nameKey: t("Essaouira & Atlantic Coast"), img: "/pictures/souira.png", descKey: t("The wind, the sea, and a creative energy completely different from the interior. Ideal for surfers, families, and those seeking another Morocco.") },
      ...
      <section className="relative h-[80vh] flex items-start justify-center text-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 text-[#ffffff] max-w-5xl space-y-6 px-6 mt-10">
          ...
          <div className="pt-20 md:pt-32">
            <Link href="/contact" className="bg-[#C07652] text-white px-10 py-4 rounded-2xl uppercase font-bold text-[11px] tracking-[0.3em] transition-all hover:bg-[#A35F3F] hover:scale-105 active:scale-95 shadow-xl">
      ...
      <section className="py-24 bg-[#2D2926] text-white px-8 mx-4 rounded-3xl">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-3 gap-16">
          <div className="text-center space-y-4">
            <p className="text-5xl md:text-8xl font-serif italic text-[#C07652]">{years}+</p>
            <p className="text-[9px] uppercase font-bold tracking-[0.3em] opacity-40">{t("Years of professional experience")}</p>
          </div>
          <div className="text-center space-y-4">
            <p className="text-5xl md:text-8xl font-serif italic text-[#C07652]">{destinations}+</p>
          ...
          <div className="text-center space-y-4 col-span-2 md:col-span-1">
            <p className="text-5xl md:text-8xl font-serif italic text-[#C07652]">{rate}%</p>
            ...
            {destinationsData.map((dest, i) => (
              <div key={i} className="bg-[#F9F7F2] group cursor-pointer border border-transparent hover:border-[#C07652]/20 transition-all duration-500 rounded-2xl overflow-hidden">
                <div className="h-64 relative overflow-hidden">
                  <Image src={dest.img} fill className="object-cover transition-transform duration-700 group-hover:scale-110" alt={dest.nameKey} />
