...
export default function CookiesPolicyPage() {
  ...
  return (
    <main className="min-h-screen bg-[#111827] px-4 pb-14 pt-24 font-sans text-[#F9FAFB] sm:px-6 md:px-10 md:pb-20 lg:px-16">
      <div className="max-w-5xl mx-auto">
        
        <div className="mb-12 border-b border-[#4B5563]/30 pb-8 text-center md:mb-16 md:pb-10 md:text-left">
          <p className="mb-4 text-[11px] font-bold uppercase tracking-[0.32em] text-[#4B5563] sm:text-[12px] sm:tracking-[0.5em]">
          ...
          <p className="text-[11px] uppercase tracking-[0.22em] text-[#9CA3AF] sm:text-sm sm:tracking-widest">
        ...
        <section className="mb-14 sm:mb-16 md:mb-20">
          ...
          <div className="space-y-4 text-base leading-relaxed text-[#9CA3AF]/90 sm:space-y-6 sm:text-[17px] md:text-lg">
            <p>
        ...
        <section className="mb-14 sm:mb-16 md:mb-20">
          <div className="grid grid-cols-1 items-start gap-6 md:grid-cols-2 md:gap-12 md:border-l md:border-[#4B5563]/20 md:pl-8">
            <h2 className="text-2xl font-serif leading-tight text-white md:text-3xl">
              1. {t("What Are Cookies?")}
            </h2>
            <div className="space-y-4 text-base leading-relaxed text-[#9CA3AF] sm:text-[17px] md:text-lg">
              <p>
        ...
        <section className="mb-14 sm:mb-16 md:mb-20">
          ...
          <div className="overflow-x-auto rounded-[24px] border border-[#4B5563]/20 bg-white/5 backdrop-blur-sm md:rounded-3xl">
            <table className="w-full text-left text-sm border-collapse">
              <thead>
                <tr className="bg-[#4B5563]/10 text-[10px] uppercase tracking-[0.22em] text-[#E5E7EB] sm:tracking-[0.3em]">
                  <th className="border-b border-[#4B5563]/20 p-4 sm:p-6 md:p-8">{t("Type")}</th>
                  <th className="border-b border-[#4B5563]/20 p-4 sm:p-6 md:p-8">{t("Purpose")}</th>
                  <th className="border-b border-[#4B5563]/20 p-4 sm:p-6 md:p-8">{t("Consent")}</th>
                </tr>
              </thead>
              <tbody className="text-[#9CA3AF]">
                {[
                  ...
                  <tr key={i} className="border-b border-white/5 hover:bg-white/5 transition duration-500">
                    ...
                    <td className={`p-4 text-[10px] font-bold sm:p-6 md:p-8 ${row.consent === "Not required" ? "text-[#4B5563]" : ""}`}>{t(row.consent)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section className="mb-14 sm:mb-16 md:mb-20">
          ...
          <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
            {[
              ...
              <div key={idx} className="group rounded-[24px] border border-white/10 bg-white/5 p-5 transition duration-500 hover:border-[#4B5563]/40 sm:p-6 md:rounded-3xl md:p-8">
                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#4B5563]">{t(cookie.cat)}</span>
                <h3 className="mb-4 mt-3 text-lg font-mono text-white transition group-hover:text-[#E5E7EB] sm:text-xl">{cookie.name}</h3>
                <p className="mb-6 text-[11px] leading-relaxed text-[#9CA3AF] sm:text-xs md:text-sm">{t(cookie.purp)}</p>
                <div className="border-t border-white/5 pt-5 text-[10px] font-medium uppercase tracking-[0.2em] text-[#9CA3AF]/40 sm:pt-6 sm:tracking-widest">
        ...
        <section className="mb-14 sm:mb-16 md:mb-20">
          ...
          <div className="grid grid-cols-1 gap-4 text-[13px] font-light text-[#9CA3AF]/80 sm:text-sm md:grid-cols-2">
        ...
        <section className="mb-14 grid grid-cols-1 gap-10 border-t border-white/10 pt-12 sm:mb-16 sm:pt-14 md:mb-20 md:gap-16 md:pt-16 lg:grid-cols-2">
          <div>
            ...
            <p className="mb-6 text-[13px] leading-relaxed text-[#9CA3AF] sm:mb-8 sm:text-sm">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              {["Chrome", "Firefox", "Safari", "Edge"].map((b, i) => (
                <div key={i} className="py-4 px-2 border border-white/5 rounded-2xl text-[9px] uppercase tracking-widest text-[#9CA3AF] text-center hover:bg-[#4B5563]/20 transition">
                  {b}
                </div>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="space-y-4 border-l-2 border-[#4B5563] bg-[#4B5563]/5 p-6 text-[13px] italic text-[#9CA3AF] sm:space-y-6 sm:p-8 sm:text-sm md:p-10">
              <p>
        ...
        <footer className="flex flex-col items-start justify-between gap-8 border-t border-white/10 pt-12 sm:gap-10 sm:pt-16 md:flex-row md:items-end md:pt-20">
          <div className="text-left max-w-md">
            ...
            <p className="mb-6 text-xs leading-relaxed text-[#9CA3AF]">
              {t("If you have questions about this cookies policy, please contact our Data Privacy Officer.")}
            </p>
            <a href="mailto:contact@welivemorocco.com" className="text-xl font-serif text-[#E5E7EB] underline decoration-[#4B5563] underline-offset-8 transition hover:text-white sm:text-2xl">
              contact@welivemorocco.com
            </a>
          </div>
          <div className="space-y-3 text-left md:text-right md:space-y-4">
            <div className="text-[10px] uppercase tracking-[0.4em] text-[#9CA3AF]/40">
              © 2026 WeLiveMorocco.
            </div>
            <div className="text-[9px] text-[#4B5563] uppercase font-bold tracking-widest">
