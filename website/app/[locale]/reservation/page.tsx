      ...
      <div className="max-w-3xl mx-auto bg-white p-10 md:p-16 rounded-[3rem] shadow-2xl border border-gray-100">
        ...
        <form className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-[#003366] font-bold mb-2 ml-2 text-sm uppercase">Nom Complet</label>
            ...
            <div>
              <label className="block text-[#003366] font-bold mb-2 ml-2 text-sm uppercase">Téléphone</label>
          ...
          <div>
            <label className="block text-[#003366] font-bold mb-2 ml-2 text-sm uppercase">Destination Souhaitée</label>
            <select className="w-full p-4 rounded-2xl bg-gray-50 border border-gray-200 focus:border-orange-500 outline-none transition-all appearance-none">
              ...
              <option>Andalousie & Séville</option>
              <option>Costa Del Sol / Malaga</option>
              <option>Dubaï Premium</option>
            </select>
          </div>

          <div>
            <label className="block text-[#003366] font-bold mb-2 ml-2 text-sm uppercase">Message (Optionnel)</label>
            <textarea rows={4} className="w-full p-4 rounded-2xl bg-gray-50 border border-gray-200 focus:border-orange-500 outline-none transition-all" placeholder="Avez-vous des demandes spéciales ?"></textarea>
          </div>
